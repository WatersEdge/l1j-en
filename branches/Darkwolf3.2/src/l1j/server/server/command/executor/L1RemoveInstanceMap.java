...
public class L1RemoveInstanceMap implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if(flag){
				pc.sendPackets(new S_SystemMessage ("instance map ["+mapid+"], and has been cleared."));
			}else{
				pc.sendPackets(new S_SystemMessage ("instance map ["+mapid+"] does not exist."));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage(cmdName + "Please enter mapID."));
		}
	}
}